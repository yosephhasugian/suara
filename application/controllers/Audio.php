...
public function index() {
    ...
    public function add_announcer() {
        ...
        if ($kategori === 'po_plat' || $kategori === 'po') {
        ...
        } elseif ($kategori === 'po_body') {
            $text_id = sprintf(
                "Mohon perhatian. Kepada seluruh penumpang bus %s dengan nomor bodi %s, tujuan %s, Mohon agar segera menaiki bus Anda di pintu %s, dikarenakan bus Anda akan segera diberangkatkan. Terima kasih.",
