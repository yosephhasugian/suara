...
$(document).ready(function() {
    ...
    function updatePreview() {
        ...
        if (kategori === 'po_plat') {
            ...
            previewText = `Mohon perhatian. Kepada seluruh penumpang bus <strong class="text-warning">${po}</strong> dengan seri atau tipe bus <strong class="text-warning">${tipe}</strong>, tujuan <strong class="text-warning">${jurusan}</strong>, Mohon agar segera menaiki bus Anda di pintu <strong class="text-warning">${pintu}</strong>, dikarenakan bus Anda akan segera diberangkatkan. Terima kasih.`;
        } else {
