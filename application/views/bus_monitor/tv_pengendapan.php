...
<head>
    ...
    <style>
        ...
        .header {
            background: #111;
            border-bottom: 4px solid #6c757d;  /* Gray */
            padding: 12px 25px;
            display: flex;
        ...
        @keyframes pulse-counter {
            0%, 100% { border-color: rgba(108, 117, 125, 0.3); box-shadow: 0 0 15px rgba(108, 117, 125, 0.2); }
            50% { border-color: rgba(173, 181, 189, 0.6); box-shadow: 0 0 25px rgba(108, 117, 125, 0.4); }
        }
        .bus-counter i { color: #6c757d; font-size: 16px; }
        .bus-counter .number { 
            font-size: 24px; 
            color: #6c757d; 
            font-weight: 900;
        ...
        .table tbody tr:hover {
            ...
            box-shadow: inset 0 0 20px rgba(108, 117, 125, 0.2);
        }
        ...
        @keyframes pulse-badge {
            0%, 100% { box-shadow: inset 0 0 8px rgba(0,0,0,0.4), 0 0 0 0 rgba(108, 117, 125, 0.4); }
            50% { box-shadow: inset 0 0 8px rgba(0,0,0,0.4), 0 0 15px 3px rgba(108, 117, 125, 0.6); }
        }
    ...
    <div class="header-left">
        <h1>
            <span class="header-icon">
                <i class="fas fa-bus"></i><i class="fas fa-parking text-primary" style="font-size: 0.6em; margin-left: -8px; vertical-align: top;"></i>
            </span>
            AREA PENGENDAPAN - TERMINAL PULO GEBANG
        </h1>
            ...
            html = `<tr>
                <td colspan="5">
                    <div class="empty-state">
                        <i class="fas fa-bus"></i>
                        <p>TIDAK ADA BUS DI AREA PENGENDAPAN</p>
                        <small class="text-muted">Data bus yang parkir otomatis tersinkronisasi di layar monitor</small>
                    </div>
                </td>
            </tr>`;
        } else {
