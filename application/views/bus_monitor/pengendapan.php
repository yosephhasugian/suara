...
<div class="content-wrapper p-3">
    <h4 class="mb-3">⚪ Admin Pengendapan</h4>
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header bg-secondary text-white">
                    <i class="fas fa-list me-2"></i>Bus Menunggu Pengendapan
                </div>
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header bg-warning text-dark">
                    <i class="fas fa-clock me-2"></i>Input Pengendapan
                </div>
                <div class="card-body">
                    ...
                    <button class="btn btn-warning w-100 py-2 fw-bold text-dark" onclick="simpan()">
                        <i class="fas fa-check-circle me-2"></i>✔️ Konfirmasi Pengendapan
                    </button>
            ...
            <div class="alert alert-secondary mt-3 small">
                ...
                <strong>Info:</strong> List hanya menampilkan bus yang BELUM di area pengendapan. 
...
const CURRENT_AREA = "pengendapan"; // ✨ AREA: PENGENDAPAN
...
// ================= LOAD BUS (FILTER: Jangan tampilkan yang sudah di area pengendapan) =================
function loadBus(){
        ...
        if(!res || res.length === 0){
            ...
            res.forEach(b => {
                if(b.plat_nomor && b.plat_nomor.trim() !== "") {
                    ...
                    html += `
                        <div class="card mb-2 shadow-sm border-start border-4 border-secondary" 
...
function simpan(){
    ...
    Swal.fire({
        title: 'Konfirmasi Pengendapan?',
        html: `
            <div class="text-start">
                <strong>🚌 ${nopol}</strong><br>
                <strong>🎯 ${tujuan}</strong><br>
                <small class="text-muted">Bus akan dipindah ke area: <strong>pengendapan</strong></small>
            </div>
        `,
        icon: 'question',
                ...
                success: function(res){
                    if(res.status){
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil! 🎉',
                            text: 'Bus ' + nopol + ' sudah dikonfirmasi pengendapan',
                            timer: 2000,
