...
<head>
    ...
    <style>
        ...
        @keyframes pulse-counter {
            0%, 100% { box-shadow: 0 4px 15px rgba(0, 123, 255, 0.5); }
            50% { box-shadow: 0 4px 25px rgba(0, 123, 255, 0.8); }
        }
        ...
        .table-wrapper::-webkit-scrollbar-thumb { background: #007bff; border-radius: 3px; }
        ...
        .waktu { font-family: 'Orbitron', sans-serif; color: #6ea8fe; font-weight: 700; }
        ...
        /* ================= ROW STRIPING ================= */
        tbody tr:nth-child(even) { background: rgba(0,123,255,0.08); }
...
<div class="header">
    <div class="header-left">
        <h1> <span class="number" id="busCount">0</span><small style="font-size:12px; opacity:0.9">BUS</small> AREA KEBERANGKATAN - TERMINAL PULO GEBANG</h1>
        <!-- ✨ BUS COUNTER -->
...
function formatTime(timestamp, areaUpdated) {
    // Prioritaskan area_updated_at untuk display jam di area tertentu
    ...
    $.get(BASE_URL + 'bus_monitor/get_tv_keberangkatan', function(res) {
        ...
        if (!res || res.length === 0) {
            ...
            validBuses.forEach(b => {
                let jam = formatTime(b.created_at, b.area_updated_at); // ✨ Pakai area_updated_at
