...
<div class="content-wrapper p-3">
    <h4 class="mb-3">🔵 Admin Keberangkatan</h4>
    ...
    <div class="row">
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header bg-primary text-white">
                    <i class="fas fa-list me-2"></i>Bus Menunggu Keberangkatan
                </div>
        ...
        <!-- FORM INPUT (SIMPLIFIED - NO GATE) -->
        <div class="col-md-5">
            <div class="card">
                <div class="card-header bg-success text-white">
                    <i class="fas fa-bus me-2"></i>Input Keberangkatan
                </div>
                <div class="card-body">
                    ...
                    <label class="fw-bold small text-muted">Tujuan Akhir</label>
                    ...
                    <button class="btn btn-success w-100 py-2 fw-bold" onclick="simpan()">
                        <i class="fas fa-check-circle me-2"></i>✔️ Konfirmasi Keberangkatan
                    </button>
            ...
            <div class="alert alert-info mt-3 small">
                ...
                <strong>Info:</strong> List hanya menampilkan bus yang BELUM di area keberangkatan. 
...
const CURRENT_AREA = "keberangkatan";
...
// ================= LOAD BUS (FILTER: Jangan tampilkan yang sudah di area keberangkatan) =================
function loadBus(){
        ...
        if(!res || res.length === 0){
            ...
            res.forEach(b => {
                if(b.plat_nomor && b.plat_nomor.trim() !== "") {
                    ...
                    if(b.area == 'kedatangan') badgeColor = 'bg-info';
...
function pilih(id, nopol, tujuan){
    ...
    // Auto focus ke tombol simpan untuk cepat proses
    setTimeout(() => {
        document.querySelector('button[onclick="simpan()"]')?.focus();
    }, 100);
}

// ================= SIMPAN / KONFIRMASI (NO GATE) =================
function simpan(){
    let id = $('#id').val();
    ...
    Swal.fire({
        ...
        html: `
            <div class="text-start">
                ...
                <small class="text-muted">Bus akan dipindah ke area: <strong>keberangkatan</strong></small>
            </div>
        `,
        icon: 'question',
                ...
                success: function(res){
                    if(res.status){
                        Swal.fire({
                            icon: 'success',
                            title: 'Berhasil! 🎉',
                            text: 'Bus ' + nopol + ' sudah dikonfirmasi keberangkatan',
                            timer: 2000,
...
function resetForm(){
    ...
    $('#nopol').val('');
    $('#tujuan').val('');
    // ✅ Gate dihapus dari reset
    $('.card').removeClass('border-success');
}

// ================= KEYBOARD SHORTCUT =================
document.addEventListener('keydown', function(e){
    // Enter untuk simpan (jika form terisi)
